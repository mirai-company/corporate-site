...
export const projects: Project[] = [
  ...
  },
  {
    ...
    fullDescriptionEn: "The Mibyou Sokusai Project promotes a positive, community-based approach to health rather than endurance-based methods. Aiming to create new regional value through health, it simultaneously achieves resident wellness and regional industry revitalization through diet, exercise, and local resources.",
    domain: "life",
    domainLabel: "生命資本",
    year: "2008",
